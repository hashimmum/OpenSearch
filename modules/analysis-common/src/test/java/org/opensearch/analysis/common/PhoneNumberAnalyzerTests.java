...
public class PhoneNumberAnalyzerTests extends OpenSearchTokenStreamTestCase {
    private static final String RESOURCE = "/org/opensearch/analysis/common/phone_analysis.json";
    ...
    public void testEuropeDetailled() throws IOException {
        ...
        assertTokenStreamContents(
            phoneAnalyzer.tokenStream("test", "tel:+441344840400"),
            new String[] {
                "tel:+441344840400",
                "tel:",
                "441344840400",
    ...
    public void testEuropeDetailledSearch() throws IOException {
        ...
        /*
        assertTokenStreamContents(
            phoneSearchAnalyzer.tokenStream("test", "tel:+441344840400"),
            new String[] { "tel:+441344840400", "tel:", "441344840400", "44", "1344840400", }
        );
         */
    }
